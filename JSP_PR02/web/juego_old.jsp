                ...
                <c:otherwise>
                    <c:choose>
                        <c:when test='${param.nombre != null}'>
                            ...
                            <hr>
                            <form style="color:white" class="text-center pr-5 pb-5 pl-5" action="juego.jsp" method="post">
                            ...
                            <c:choose>
                                <c:when test='${param.miNumero == numSecreto}'>
                                ...
                                <c:when test='${param.miNumero != numSecreto}'>
                                    <c:if test='${param.miNumero > numSecreto}'>
                                        <h2 style="color:white">EL SECRETO ES MENOR QUE TU NUMERO</h2>
                                    </c:if>
                                    <%  
